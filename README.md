...
<details>
<summary>🌱 Terratech – AI-based Agricultural Monitoring System</summary>

**🔗 [View Project](https://github.com/debarun23/Terratech-Smart-Agriculture-with-IoT-Robotics-AI)**  
- IoT + AI-powered crop health monitoring (ESP32-CAM, multi-sensors)  
- **95% accuracy** in plant disease detection using Edge Impulse & OpenCV  
- Reduced water usage by **28.6%** with automated irrigation  
</details>

<details>
<summary>📊 Crypto Price Tracker Dashboard</summary>

**🔗 [View Project](https://github.com/debarun23/Crypto-Price-Tracking-App)**  
- Real-time tracking of **50+ cryptocurrencies** using CoinGecko API  
- Interactive charts with Google Charts + React Hooks  
- **40% faster** load times after Vite migration  
</details>

<details>
<summary>🤖 Job Granite Guide – AI Interview Trainer</summary>

**🔗 [View Project](https://github.com/debarun23/job-granite-guide)**  
- Agentic AI agent for interview preparation using IBM Granite & RAG  
